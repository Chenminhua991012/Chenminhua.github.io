...
<center>
    <div id="page">
        <div class="head">
            <div class="imgBox">
                <img class="img-slide img1" src="img/register/register1.jpg">
                <img class="img-slide img2" src="img/register/register2.jpg">
                <img class="img-slide img3" src="img/register/register3.jpg">
                <img class="img-slide img4" src="img/register/register4.jpg">
            </div>
    ...
    <ul align="right">
        <audio src="music/register.mp3" autoplay controls loop></audio>
    </ul>
    <div class="foot">
        <p>版权所有 禁止盗版</p>
        <p>欢迎来到陈民华的博客</p>
